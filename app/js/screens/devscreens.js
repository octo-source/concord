...
const SCREENS = [
  ...
  ["Calibration Studio", `#/p/${SLUG}/goldsets/g_theme1`, "Sample (design, n, π note) · Code (full-bleed sprint: j/k, 1–9, f, m, timer, quiet completion) · Test (human-first banner + band, confusion heat-tables, iteration log + McNemar) · Adjudicate (queue, pick-or-enter)"],
  ...
  ["Workbench — triangulation", `#/p/${SLUG}/analyses/an_triang`, "scatter with divergence emphasis + divergence browser into the inspector"],
  ["Workbench — subgroup", `#/p/${SLUG}/analyses/an_subgroup`, "agreement by metadata group; flagged rows in signal"],
